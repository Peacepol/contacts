...
export class ContactsService {
  ...
  addContact(addContactRequest: Contact): Observable<Contact>{
    addContactRequest.id = '00000000-0000-0000-0000-000000000'
  ...
  updateContact(id:string,updateContact:Contact):Observable<Contact>{
    return this.http.put<Contact>(this.baseApiUrl + 'api/contacts/' + id, updateContact);
  }
